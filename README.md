...
### 1. Gradient Boosting: Residual Fitting, Metric Choice & the Threshold as a Hyperparameter
...
### 2. AdaBoost: Boosting, Encoding by Cardinality & What Tuning Actually Buys You
...
### 3. Income Evaluation: Random Forest & the Silent-Column-Drop Pitfall
...
### 4. Decision Trees: Depth, Regularization & the Cost of an Untuned Tree
...
### 5. Mobile Price Classification: K-Nearest Neighbors & the Limits of Feature Scaling
...
### 6. SMS Spam Detection: Text Classification with Naive Bayes
...
### 7. Iris Species Classification: Gaussian Naive Bayes
...
### 8. Support Vector Machines: The Kernel Trick, Classification & Regression
...
### 9. Google Play Store: Data Preprocessing & Feature Engineering
...
### 10. Predictive Modeling: Capturing Non-Linear Relationships (Polynomial Regression)
...
### 11. Predictive Modeling: Market & Health Metrics (Linear Regression)
...
### 12. Wine Quality: Exploratory Data Analysis (EDA)
...
### 13. Advanced Missing Data Management
